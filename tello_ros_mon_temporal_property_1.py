...
# property to verify
PROPERTY = '''({topic: 'agentReact', data_mod: 'reactRed'} -> once[2:5]{topic: 'detectRed', detectRed: 'True'}) and (not {topic: 'agentReact', data_mod: 'reactRed'} -> not (once[2:5]{topic: 'detectRed', detectRed: 'True'}))'''
